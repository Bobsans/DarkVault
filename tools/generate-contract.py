...
schemas["token.create.Request"]["properties"]["parameters"]["properties"]["expiresAt"]["description"] = "Omitted or null: 30 days. Explicit expiry must be in the future and within 90 days."
